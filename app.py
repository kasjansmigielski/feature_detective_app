                                    ...
                                    if st.session_state['generate_data_button_clicked']:
                                        ...
                                        if st.session_state['classification']:
                                            ...
                                            if has_single_member_class:
                                                ...
                                                # konfiguracja
                                                cls_setup(data=df, target=st.session_state['target_choice'], session_id=123, html=False)
                                                ...
                                                with st.spinner("Trwa generowanie danych przez AI..."):
                                                    ...
                                                    # stara metoda - znalezienie najlepszego modelu - z wykluczeniem NIEobsługujących wykresu 'feature' !! -> czas trenowania ~5min dla fold=10
                                                    ...
                                                    # best_classify_model = cls_compare_models(include=['rf', 'lr'], fold=10)
                                            ...
                                            if hasattr(best_classify_model, 'coef_') or hasattr(best_classify_model, 'feature_importances_'):
                                                ...
                                                cls_generated_plot_name = 'Feature Importance.png'
                                                cls_new_plot_name = 'Classification Feature Importance.png'

                                                # zmiana automatycznie generowanej nazwy wykresu
                                                if os.path.exists(cls_generated_plot_name):
                                                    os.rename(cls_generated_plot_name, cls_new_plot_name)
                                                    
                                                    # wyświetlenie wykresu
                                                    cls_plot_image = st.image(cls_new_plot_name, use_column_width=True)
                                        ...
                                        #
                                            ...
                                            if hasattr(best_regress_model, 'coef_') or hasattr(best_regress_model, 'feature_importances_'):
                                                ...
                                                reg_generated_plot_name = 'Feature Importance.png'
                                                reg_new_plot_name = 'Regression Feature Importance.png'

                                                # zmiana automatycznie generowanej nazwy wykresu
                                                if os.path.exists(reg_generated_plot_name):
                                                    os.rename(reg_generated_plot_name, reg_new_plot_name)
                                                    
                                                    # wyświetlenie wykresu
                                                    reg_plot_image = st.image(reg_new_plot_name, use_column_width=True)

                                                    if reg_plot_image:
                                                        st.markdown('#### Opis wykresu:')
                                                        reg_description = describe_plot(reg_new_plot_name)
                            ...
                            if st.session_state['generate_data_button_clicked']:
                                ...
                                if st.session_state['classification']:
                                    ...
                                    if has_single_member_class:
                                        ...
                                        # konfiguracja
                                        cls_setup(data=ready_df, target=st.session_state['target_choice'], session_id=123, html=False)
                                ...
                                #
                                    ...
                                    # konfiguracja
                                    reg_setup(data=ready_df, target=st.session_state['target_choice'], session_id=123, html=False)
